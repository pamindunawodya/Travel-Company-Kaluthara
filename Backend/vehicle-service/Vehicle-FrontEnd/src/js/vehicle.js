            ...
            success: function (data) {
                if (data.code === '200') {
                    ...
                    for (var i = 0; i < vehicles.length; i++) {
                        ...
                        $("#card-container .row:last-child div:nth-child(1) > img").attr('src', `data:image/png;base64,`+vehicle.vehicle_img+``);
                        $("#card-container .row:last-child div:nth-child(2) > img").attr('src', `data:image/png;base64,`+vehicle.driver_license_image+``);
                    }
                } else {
