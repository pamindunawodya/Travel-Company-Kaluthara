...
$("#btnCustomerDelete").click(function () {
    ...
    $.ajax({
        ...
        success:function (resp){
            // alert(resp.message);
            swal("Delete package details successful !", "Click the ok !", "success");
           loadAllUsers();
        },
        error:function (e) {
 ...
 function getAllAjaxItemReq(name) {
     $.ajax({
         url: "http://localhost:8080/Mapping/api/user/user/search?name=" +name,
         type: "GET",
         success: function(resp) {
             if (resp.code === '200') {
                 console.log(resp)
