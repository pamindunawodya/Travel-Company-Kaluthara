                    ...
                    for (var i = 0; i < vehicles.length; i++) {
                        ...
                        var card = `
                                      <div class="col-12 col-md-6 col-lg-3 card-wrapper mt-4">
                                        <div class="card">
                                          <img class="card-img-top vehicle-image" src="images/1.jpg" alt="..."> 
                                          <img class="card-img-top drivinglicen-img" src="images/1.jpg" alt="...">
                                          <div class="card-body">
                        ...
                        $("#card-container .col-12:last-child div .vehicle-image").attr('src', `data:image/png;base64,`+vehicle.vehicle_img+``);
                        $("#card-container .col-12:last-child div.drivinglicen-img").attr('src', `data:image/png;base64,`+vehicle.driver_license_image+``);
                    }
                } else {
