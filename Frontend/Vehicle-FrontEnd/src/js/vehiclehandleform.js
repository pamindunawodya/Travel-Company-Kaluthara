...
function loadAllVehicleData() {
  ...
  <tr>
    <td>${cus.id}</td>
    <td>${cus.vehicle_brand}</td>
    <td>${cus.vehicle_category}</td>
    <td>Placeholder Data</td>
    <td>${cus.fuel_type}</td>
    <td>${cus.hybrid_OR_nonHybrid}</td>
    <td>${cus.fuel_usage}</td>
    <td>${cus.seatCapacity}</td>
    <td>${cus.vehicle_type}</td>
    <td>${cus.driver_name}</td>
    <td>${cus.driver_contact}</td>
    <td><img width="100"></td>
    <td><img width="100"></td>
  </tr>
`;
                    console.log("table pass data");
